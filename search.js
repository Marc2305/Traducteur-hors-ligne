...
function Search (searchName) {
    ...
    if (result === 0) {
        for (iIndex = 0; i >LengthAnnexeFRListN ; i++){
            if(searchName === AnnexeFRListN[i]){
                result = 1;
                return(
                    AnnexeFRListN[i]
                )
    ...
    if (result === 0) {
        for (iIndex = 0; i >LengthAnnexeFRListO ; i++){
            if(searchName === AnnexeFRListO[i]){
                result = 1;
                return(
                    AnnexeFRListO[i]
                )
    ...
    if (result === 0) {
        for (iIndex = 0; i >LengthAnnexeFRListP ; i++){
            if(searchName === AnnexeFRListP[i]){
                result = 1;
                return(
                    AnnexeFRListP[i]
                )
    ...
    if (result === 0) {
        for (iIndex = 0; i >LengthAnnexeFRListQ ; i++){
            if(searchName === AnnexeFRListQ[i]){
                result = 1;
                return(
                    AnnexeFRListQ[i]
                )
